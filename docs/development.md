...
| Property blueprints | Partial | Placement, construction order, cost, collision, access, temperature, lighting, capacity, schedules, employee logistics, route candidates, sprinklers, Cleaner planning, storage summaries, production movement, physical feasibility | Mutable runtime state, dynamic obstacles, and unsupported collider proof remain outside the static model |
