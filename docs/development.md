...
| Property blueprints | Partial | Placement, construction order, cost, collision, access, temperature, lighting, capacity, schedules, employee logistics | Mutable runtime state, dynamic obstacles, and unsupported collider proof remain outside the static model |
...
Exporter `0.0.20` targets *Schedule I* `0.4.6f12`, MelonLoader `0.7.3`, S1API `3.1.6`, and AssetRipper `1.3.14`.
