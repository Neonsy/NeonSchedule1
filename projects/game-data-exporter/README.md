...
Exporter `0.0.29` targets *Schedule I* `0.4.6f13`, MelonLoader `0.7.3`, S1API `3.1.6`, and AssetRipper `1.3.14`.
...
- Map regions, locations, services, access zones, employee navigation, player movement evidence, vehicle graphs, and endpoint projections
...
Navigation evidence records the agent configuration used for each graph.
